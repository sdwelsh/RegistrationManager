...
public class LinkedList<E> extends AbstractSequentialList<E> {
	...
	/**
	 * Overrides the add method to make sure that there aren't repeats of data being
	 * added
	 * 
	...
	private class LinkedListIterator implements ListIterator<E> {
		 ...
		 * 
		 * @return true if the next element exists false if it doesn't
		 */
		@Override
		 ...
		 * 
		 * @return true if previous element exists false if the element doesn't
		 */
		@Override
